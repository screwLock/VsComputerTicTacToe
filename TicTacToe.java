...
public class TicTacToe extends JFrame implements  ActionListener {
  ...
  private JTextField xName = new JTextField();
  private Board board;
  private int lineThickness=1;
  private Color oColor=Color.WHITE, xColor=Color.RED;
  ...
  public TicTacToe() {
    ...
    topPanel.add(oButton=new JButton("Player 1 Name"));
    topPanel.add(xButton=new JButton("Player 2 Name"));
    topPanel.add(oName=new JTextField());
    topPanel.add(xName);
